...
const CourseDetails = () => {
  ...
  const fetchCourseData = async () => {
    const foundedCourse = allCourses.find((course) => course._id === id);
    setCourseData(foundedCourse);
  };
  ...
  return courseData ? (
    <>
      <div className=" flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-32 pt-20 text-left">
        <div className=" absolute top-0 left-0 w-full section-height z-0 bg-gradient-to-b from-cyan-100/70"></div>
        ...
        <div className=" max-w-xl z-10 text-gray-500">
          ...
          <div className=" flex items-center space-x-2 pt-3 pb-1 text-sm">
            <p>{calculateRating(courseData).toFixed()}</p>
            <div className=" flex">
              {[...Array(5)].map((_, i) => (
                <img
                  key={i}
          ...
          <div className=" p-5">
            <div className=" flex items-center gap-2">
              ...
              <p className=" text-red-500">
                <span className=" font-medium">5 days</span>left at this rice!
              </p>
            </div>
            ...
            <div className=" flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500">
              ...
              <div className=" flex items-center gap-1 ">
                ...
                <p>{calculateNoOfCourse(courseData)}&nbsp;lessons</p>
              </div>
            </div>
            ...
            <div className=" pt-6">
              ...
              <ul className=" ml-4 pt-2 text-sm md:text-default list-disc text-gray-500">
                ...
                <li>Certificate of complitation.</li>
              </ul>
            </div>
          </div>
        </div>
